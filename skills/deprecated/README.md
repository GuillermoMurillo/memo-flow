...
- [caveman](caveman/SKILL.md): terse-mode reply style. Superseded by `pager`'s concise mode, which absorbed its compression rules without the device stream.
- [zoom-out](zoom-out/SKILL.md): step back and re-frame when stuck in the weeds. Retired in the mattpocock/skills v1.0 alignment; not carried forward.
